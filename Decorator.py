...
'''
#iterator
#iterator in codebasics youtube channel
class remotecontrol():
    def __init__(self):
        self.values=["hbo","starsports","animalplanet","wb"]
        self.index=-1
...
#abstractbasecalss for implimenting methods
...
class b(a):
    def do_something(self):
        #self.value=self.value+42
        return self.value+42


b1=b(10)
print(b1.do_something())

#duckTyping for accessing methods there is no inheritance
...
obj=father("hari","babu",20)
obj1=son("shekar","babu",20)
obj2=str1("king","nag",20)
